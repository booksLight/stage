...
<main>
 ...
 <!--  CUSTOMER DETAILS  TAB -->
  <section id="content1">
      ...
      <table>
      <form:form class="go-right" action="#" method="post" commandName="customer">
   ...
   <section id="content2">
    ...
    <table>
        ...
        <tr>
        	...
        	<td></td>
        	<td><form:input path="billingAddress.apartmentNumber" id="billingApartmentNumber" placeholder="House Name/Number" readonly="true"/>
			</td>
        </tr>
         ...
         <tr>
         	...
         	<td></td>
         	<td> <form:input path="billingAddress.streetName" id="billingStreet"  placeholder="Street" readonly="true"/> </td>
       </tr>
        
          <tr>
          	<td >Customer City </td>
          	<td></td>
         	<td>   <form:input path="billingAddress.city" id="billingCity" placeholder="City/Town " readonly="true" />  </td>
         </tr>
         
        <tr>
          	<td >Customer State </td>
          		<td></td>
          	<td>   <form:input path="billingAddress.state" id="billingState" placeholder="State/Provision" readonly="true"/></td>
         </tr>
          <tr>
          	<td >PIN-CODE </td>
          		<td></td>
          	<td>   <form:input path="billingAddress.zipCode" id="billingZip"  placeholder="PIN/ZIP" readonly="true"/></td>
         </tr>
         ...
         <tr>
          	<td >Customer Country </td>
          		<td></td>
          	<td>   
          		<form:select path="billingAddress.country" id="billingCountry" readonly="true">
