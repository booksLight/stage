...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Інтернет-магазин на Spring Framework!</h1><b>${model.title}</b>
        ...
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Слайд - 2: Інтернет-магазин на Spring Framework!</h1>
        ...
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Слайд 3: Інтернет-магазин на Spring Framework!</h1>
