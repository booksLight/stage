...
import org.brand.self.service.CartItemService;
import org.brand.self.service.CartService;
import org.brand.self.service.CustomerService;
import org.brand.self.service.ProductService;
...
public class CartResources {
    ...
    public void addItem (@PathVariable(value = "productId") int productId){
        Customer customer = customerService.getCustomerByUsername("USER1");
